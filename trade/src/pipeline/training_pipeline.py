from src.entity.config_entity import TrainingPipelineConfig,fyersdataconfig,DataIngestionConfig,ModelPusherConfig,DataValidationConfig,DataTransformationConfig,ModelTrainerConfig,ModelEvaluationConfig
from src.entity.artifact_entity import DataIngestionArtifact,ModelPusherArtifact, DataValidationArtifact,DataTransformationArtifact,ModelTrainerArtifact,ModelEvaluationArtifact
...
class TrainPipeline:
    ...
    def __init__(self,sd,ed,symbol):
    ...
    def start_model_evaluation(self,data_validation_artifact:DataValidationArtifact,
        ...
        try:
            ...
            model_eval = ModelEvaluation(model_eval_config, data_validation_artifact, model_trainer_artifact,data_transformation_artifact)
    ...
    def run_pipeline(self):
        try:
            ...
            #sd = datetime.datetime.strptime(self.sd, "%Y-%m-%d").date()
            #ed = datetime.datetime.strptime(self.ed, "%Y-%m-%d").date()


            a = fyersdatageneration(self.fyersdataconfig)
            a.fyersinitiation(self.symbol)
            data_ingestion_artifact:DataIngestionArtifact=self.start_data_ingestion()
            data_validation_artifact = self.start_data_validaton(data_ingestion_artifact=data_ingestion_artifact)
            data_transformation_artifact = self.start_data_transformation(
                data_validation_artifact=data_validation_artifact)
            model_trainer_artifact = self.start_model_trainer(data_transformation_artifact)
            model_eval_artifact = self.start_model_evaluation(data_validation_artifact, model_trainer_artifact,data_transformation_artifact)
